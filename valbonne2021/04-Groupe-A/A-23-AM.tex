...
%\begin{exo}
%Trouver l’ensemble des entiers $a$ tels que l’équation $2a^2-7k+2=0$ admet une solution $k$ entière.
%\end{exo}


%\begin{exo}
%Soit $p>2$ un nombre premier. Combien y a-t-il d'entiers $a\in \{0,1,\cdots,p-1\}$ tels que $c^2=pk+a$ admette une solution ?
%\end{exo}
...
%\begin{sol}
%Il est nécessaire et suffisant que $2a^2\equiv-2[7]$.
%\newline
%$2\times 4 \equiv 1[7]$ ce qui implique que $a^2\equiv -1[7]$, or les carrés modulo $7$ sont $0,1,4,2$. Ainsi il n'y a aucun réel $a$ qui satisfait cela.
%\end{sol}


%\begin{sol}
%Soient $a$ et $b$ deux restes différents modulo $p$. Supposons que $a^2\equiv b^2[p]$. Alors $(a-b)(a+b)\equiv 0[p]$, mais $p$ est premier. Par le lemme de Gauss, $p$ divise $a-b$ ou $a+b$. Ainsi $a\equiv b$ ou $-b[p]$.

%\smallskip

%De plus $a^2$ et $(p-a)^2$ sont bien congrus modulo $p$. Ainsi si $p \neq 2$, $0$ est un carré et les restes $1,2,\cdots,\frac{p-1}{2}$ ont des carrés différents. Tous les carrés sont obtenus ainsi. Il y a donc $\frac{p+1}{2}$ carrés modulo $p$ si $p\neq 2$, et modulo $2$ on vérifie qu'il y a $2$ carrés.
