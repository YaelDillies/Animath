...
Or si $z \ge 2$ on a $2^z \mod 0 \mod 4$.

Par conséquent il n'y a pas de solution si $z \ge 2$.
...
$$x^2 \le 16$$
et par positivité de $x$ il suffit de traiter les cas $0 \le x \le 4$.
...
\underline{Remarque}: il aurait été possible de réduire le nombre de cas à vérifier en remarquant que, par symétrie du problème, quitte à intervertir $x$ et $y$ on peut supposer $x \le y$.
\end{sol}
