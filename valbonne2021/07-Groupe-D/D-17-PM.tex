...
%Soit $n\geq 2$.Montrer que $P(X)=X^n+5X^{n-1}+3$ est irréductible sur $\Z[X]$.
%\end{exo}
...
%Comme $P$ a ses coefficient nuls pour $1\leq i \leq n-2$, cela assure que $i\geq n-1$ et donc que $\deg(_0+\dots+c_{n-m}X^{n-m})\leq 1$. \\
