...
%\begin{exo}
%Une compagnie aérienne propose des vols entre toutes les capitales de l'union européenne. Le coût d'un vol entre deux villes est le même dans les deux sens. Anna et Bella partent chacune d'une capitale, pas forcément la même. Anna prend systématiquement le vol le moins cher parmi les vols qui la mènent à une capitale non encore visitée, et Bella prend systématiquement le vol le plus cher parmi les vols qui la mènent à une capitale non encore visitée. De plus les prix des vols sont tous distincts. Lorsqu'elles ont visité toutes les capitales, Anna et Bella comparent le prix total qu'elles ont payé. Est-il possible qu'Anna ait plus dépensé que Bella ?
%\end{exo}
