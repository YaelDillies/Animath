\author{Matthieu Bouyer, Auguste de Lambilly}
...
\begin{sol} On a alors : $(n-2)(n^2-n-1)=5^a$. Ainsi, on a : $n-2=5^x$ et $n^2-n-1=5^y$. Il suit $5^y-5^{2x}-3\cdot5^x=1$. Donc, si $x,y\geq1$ alors $0\equiv1[5]$, ce qui est absurde. Donc $x=0$ ou $y=0$.
